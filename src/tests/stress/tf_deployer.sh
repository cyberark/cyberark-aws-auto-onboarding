                ...
                terraform init
                terraform apply -auto-approve -var="region_main=${params.mainRegion}" -var="region_sec=${params.secRegion}" -var="subnet_id_main=${params.mainSubnet}" -var="subnet_id_sec=${params.secSubnet}" -var="key_pair_main=${params.mainKP}" -var="key_pair_sec=${params.secKP}"
